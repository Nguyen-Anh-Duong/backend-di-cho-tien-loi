...
const RAPID_API_KEY = "5cad931f3amshfce3368390b8599p18e03bjsn6ef88b985860";
...
async function main() {
  ...
  while (t < 2) {
    ...
    try {
      ...
      const options = {
        method: "POST",
        url: "https://free-google-translator.p.rapidapi.com/external-api/free-google-translator?from=en&to=es&query=Thank%20you%20for%20choosing%20me!",
        headers: {
